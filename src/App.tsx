import { useState, useEffect, useLayoutEffect, useRef, useCallback, useMemo, type ClipboardEvent } from "react";
...
import { ApprovalCard, messageHasPendingApproval } from "./components/chat/ApprovalCard";
